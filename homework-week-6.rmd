...
g <- g + geom_line(data = df.ci, aes(x = testdata$Brain_Size_Species_Mean, y = lwr), colour = "blue")
g <- g + geom_line(data = df.ci, aes(x = testdata$Brain_Size_Species_Mean, y = upr), colour = "blue")
g

g <- g + geom_line(data = df.pi, aes(x = testdata$Brain_Size_Species_Mean, y = lwr), colour = "red")
g <- g + geom_line(data = df.pi, aes(x = testdata$Brain_Size_Species_Mean, y = upr), colour = "red")
g <- g + scale_colour_manual(values = c("Prediction Interval" = "red", "Confidence Interval" = "blue", "Fit" = "black"))
g
...
g2 <- g2 + geom_point()
g2 <- g2 + geom_smooth(method = "lm", formula = y ~ x, colour = "black")
...
g2 <- g2 + geom_line(data = df.ci, aes(x = testdata$logBrain_Size_Species_Mean, y = lwr), colour = "blue")
g2 <- g2 + geom_line(data = df.ci, aes(x = testdata$logBrain_Size_Species_Mean, y = upr), colour = "blue")
g2

g2 <- g2 + geom_line(data = df.pi, aes(x = testdata$logBrain_Size_Species_Mean, y = lwr), colour = "red")
g2 <- g2 + geom_line(data = df.pi, aes(x = testdata$logBrain_Size_Species_Mean, y = upr), colour = "red")
g2 <- g2 + scale_colour_manual(values = c("Prediction Interval" = "red", "Confidence Interval" = "blue", "Fit" = "black"))
g2
